...
INSERT INTO artist (nome_artista)
VALUE
  ('Walter Phoenix'),
  ('Peter Strong'),
  ('Lance Day'),
...
INSERT INTO following_artist (usuario_id, artista_id)
VALUES 
  (1, 1),
  (1, 4),
  (1, 3),
...
INSERT INTO songs (cancao, album_id, artista_id, duracao_segundos)
VALUES
  ('Soul For Us', 1, 1, 200),
